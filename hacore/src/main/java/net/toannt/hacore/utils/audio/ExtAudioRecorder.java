...
public class ExtAudioRecorder {
    ...
    public static ExtAudioRecorder getInstance() {
        ...
        int i=0;
        do {
            result = new ExtAudioRecorder(MediaRecorder.AudioSource.MIC,
                    sampleRates[i],
    ...
    /**
     *
     * Returns the state of the recorder in a ExtAudioRecorder.State typed object.
...
//			Log.d(ExtAudioRecorder.this.getClass().getName(), state + ":" + numOfBytes);
            try {
     ...
     *
     */
    public ExtAudioRecorder(int audioSource, int sampleRate, int channelConfig, int audioFormat) {
        try {
