package net.toannt.hacore.utils.alert
...
import net.toannt.hacore.behaviours.HMLifeCycleBehaviour
...
class HMAlertHelper(var context: Context) : HMLifeCycleBehaviour {
    ...
    private fun updateDataToView(content: String? = null, type: AlertContentType) {
        ...
        when (type) {
            ...
            AlertContentType.NEUTRAL -> this@HMAlertHelper.alertDialog?.setNeutralText(content)
            else -> {
